    ...
    i = function () {
      if ($('.setResizeMargin').length > 0 && e >= 1280) {
        var t = $('.container').width(),
          r = (e - t) / 2;
        $('.setResizeMargin').css('margin-left', r);
      }
    },
    n = function (e) {
      var t,
      ...
      $(e).each(function () {
        if (
          ...
          for (currentDiv = 0; currentDiv < n.length; currentDiv++)
            n[currentDiv].height(r);
          (n.length = 0), (i = topPostion), (r = t.height()), n.push(t);
        } else n.push(t), (r = r < t.height() ? t.height() : r);
        for (currentDiv = 0; currentDiv < n.length; currentDiv++)
          n[currentDiv].height(r);
      });
    },
      ...
      u.getFullYear()),
    {
        ...
        jQuery('.box-hover').on('mouseenter', function () {
          ...
          jQuery(window).on('resize', function () {
            jQuery('.modal:visible').each(l),
              jQuery('.equal-wraper').length && n('.equal-wraper .equal-col'),
              a();
          }),
      ...
      load: function () {
        e > 1023 &&
          ...
          n('.equal-wraper2 .equal-col'),
          n('.equal-wraper3 .equal-col'),
