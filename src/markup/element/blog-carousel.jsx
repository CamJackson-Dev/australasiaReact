    ...
    render() {
        return (
            <>
                ...
                <OwlCarousel
                    className="img-carousel owl-carousel owl-btn-center-lr owl-btn-3 owl-dots-none wow fadeIn"
                    loop
                    margin={30}
                    nav={true}
                    items={4}
                ...
                >
                    ...
                    <div className="item">
                        <div className="blog-post blog-grid blog-rounded blog-effect1">
                            <div className="dlab-post-media dlab-img-effect "> <Link to={'blog-details'}><img src="images/blog/grid/pic4.jpg" alt="" /></Link> </div>
                            <div className="dlab-info p-a20 border-1">
                                <div className="dlab-post-title ">
                                    <h5 className="post-title font-weight-500"><Link to={'blog-details'}>Best suited website and smart choice for your online business.</Link></h5>
                                </div>
                                <div className="dlab-post-meta ">
                                    <ul>
                                        <li className="post-date"> <i className="fa fa-comments"></i><strong>10 Aug</strong> <span> 2016</span> </li>
