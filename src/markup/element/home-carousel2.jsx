            ...
            <div className="dlab-box">
              <div className="dlab-media dlab-img-effect rotate">
                ...
                <a href="project-details">
                  <img src="images/our-services/industry/pic1.jpg" alt="" />
                </a>{' '}
              </div>
              <div className="dlab-info bg-white">
                ...
                <p className="m-b0">
                  Lorem ipsum dolor Fusce varius euismod lacus eget feugiat
                  rorem ipsum dolor consectetur...
                </p>
              </div>
              <a
                href="project-details"
                className="site-button btn-block d-flex justify-content-between white"
              >
          ...
          <div className="item">
            <div className="dlab-box">
              <div className="dlab-media dlab-img-effect rotate">
                {' '}
                <a href="project-details">
                  <img src="images/our-services/industry/pic2.jpg" alt="" />
                </a>{' '}
              </div>
              <div className="dlab-info bg-white">
                <h5 className="dlab-title m-t0">
                  <a href="/#">Tokyo Bridg</a>
                </h5>
                <p className="m-b0">
                  Lorem ipsum dolor Fusce varius euismod lacus eget feugiat
                  rorem ipsum dolor consectetur...
          ...
          <div className="item">
            <div className="dlab-box">
              <div className="dlab-media dlab-img-effect rotate">
                {' '}
                <a href="project-details">
                  <img src="images/our-services/industry/pic3.jpg" alt="" />
                </a>{' '}
              </div>
              <div className="dlab-info bg-white">
                <h5 className="dlab-title m-t0">
                  <a href="/#">Baptist Church</a>
                </h5>
                <p className="m-b0">
                  Lorem ipsum dolor Fusce varius euismod lacus eget feugiat
                  rorem ipsum dolor consectetur...
