...
class ReactRevSlider2 extends Component {
  render() {
    return (
      <>
                  ...
                  <ul>
                    ...
                    >
                      ...
                      <img
                        ...
                        alt=""
                        data-lazyload="images/main-slider/slide4.jpg"
                      ...
                      {/* <!-- LAYER NR. 1 --> */}
                      <div
                        className="tp-caption tp-shape tp-shapewrapper ov-tp "
                      ...
                      >
                        <i
                          className="fa-icon-cloud-download"
                          style={{ fontSize: '17px', marginRight: '5px' }}
                        ></i>{' '}
                        Read More{' '}
                      </Link>
...
export default ReactRevSlider2;
