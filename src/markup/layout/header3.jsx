...
class Header3 extends Component {
  render() {
    return (
      <>
        <header className="site-header header mo-left header-ind">
            ...
            <div className="container">
              <div className="row d-flex justify-content-between">
                <div className="dlab-topbar-left">
                  <ul>
                    <li>
                      <i className="flaticon-phone-call m-r5"></i> 001 1234 6789
                    </li>
                    <li>
                      <i className="ti-location-pin m-r5"></i> 6701 Democracy
                      Blvd, Suite 300, USA
                    </li>
                  </ul>
                </div>
                <div className="dlab-topbar-right">
                  <ul>
                    <li>
                      <i className="ti-skype m-r5"></i> Agency.software
                    </li>
                    <li>
                      <i className="ti-email m-r5"></i> info@example.com
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="container clearfix">
                <div className="logo-header mostion">
                  <Link to={'./'} className="dez-page">
                    <img src="images/logo-color-5.png" alt="" />
                  </Link>
                </div>
                  ...
                  <ul className="nav navbar-nav">
                    <li className="active">
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          <Link to={'./index-3'} className="dez-page">
                            Home 3
                          </Link>
                        </li>
                        <li>
                          <Link to={'./index-4'} className="dez-page">
                            Home 4
                          </Link>
                        </li>
                        <li>
                          <Link to={'./index-5'} className="dez-page">
                            Home 5
                          </Link>
                        </li>
                        <li>
                          <Link to={'./index-6'} className="dez-page">
                            Home 6 <span className="new-page">New</span>
                          </Link>
                        </li>
                        <li>
                          <Link to={'./index-7'} className="dez-page">
                            Home 7 <span className="new-page">New</span>
                          </Link>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          <Link to={'#'}>
                            Error Page <i className="fa fa-angle-right"></i>
                          </Link>
                          <ul className="sub-menu">
                            <li>
                        ...
                        <li>
                          <Link to={'./our-projects'} className="dez-page">
                            Our Projects
                          </Link>
                        </li>
                        <li>
                          <Link to={'./project-details'} className="dez-page">
                            Project Details{' '}
                          </Link>
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          <Link to={'./services-details'} className="dez-page">
                            Services Details
                          </Link>
                        </li>
                      </ul>
                    ...
                    <li>
                      ...
                      <ul className="sub-menu">
                        <li>
                          ...
                          <ul className="sub-menu">
                            <li>
                              <Link to={'./blog-standard'} className="dez-page">
                                Standard
                              </Link>
                            </li>
                            <li>
                              <Link
                                to={'./blog-standard-left-sidebar'}
                                className="dez-page"
                              >
                    ...
                    <li>
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          <Link to={'./portfolio-grid-2'} className="dez-page">
                            Portfolio Grid 2{' '}
                          </Link>
                        </li>
                        <li>
                          <Link to={'./portfolio-grid-3'} className="dez-page">
                            Portfolio Grid 3{' '}
                          </Link>
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul className="sub-menu">
                        <li>
                          <Link to={'./shop-columns'} className="dez-page">
                            Shop Columns
                          </Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link to={'./shop-cart'} className="dez-page">
                            Cart
                          </Link>
                        </li>
                        <li>
                          <Link to={'./shop-checkout'} className="dez-page">
                            Checkout
                          </Link>
                        </li>
                        <li>
                          <Link to={'./shop-wishlist'} className="dez-page">
                            Wishlist
                          </Link>
                        </li>
                        <li>
                          <Link to={'./shop-login'} className="dez-page">
                            Shop Login
                          </Link>
                        </li>
                        <li>
                          <Link to={'./shop-register'} className="dez-page">
                            Shop Register
                          </Link>
                        </li>
                      </ul>
