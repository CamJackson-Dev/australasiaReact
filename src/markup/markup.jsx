...
import AboutNz from './pages/aboutNz';
import AboutAus from './pages/aboutAus';
import AboutPng from './pages/aboutPng';
    ...
    return (
      ...
      <BrowserRouter>
        <Switch>
          ...
          <Route path="/about-nz" component={AboutNz} />
          <Route path="/about-aus" component={AboutAus} />
          <Route path="/about-png" component={AboutPng} />
