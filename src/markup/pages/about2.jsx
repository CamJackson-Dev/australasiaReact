        ...
        <div className="page-content bg-white">
          ...
          <div className="content-block">
              ...
              <div className="container">
                <div className="section-content">
                  <div className="row">
                    ...
                    <div
                      className="col-6 col-lg-3 col-md-6 col-sm-6 m-b30 wow fadeInUp"
                      data-wow-delay="0.2s"
                    >
                    ...
                    <div
                      className="col-6 col-lg-3 col-md-6 col-sm-6 wow fadeInUp"
                      data-wow-delay="0.4s"
                    >
                      <div className="dlab-media dlab-img-overlay6 gradient radius-sm">
              ...
              <div className="container-fluid">
                <div className="row dzseth">
                  ...
                  <div className="col-lg-6 col-md-12 col-xs-12 bg-black-light p-lr0 dis-tbl">
                    <div
                      className="p-a30 dis-tbl-cell wow fadeInRight"
                      data-wow-delay="0.2s"
                    >
                      <div className="max-w500 m-auto p-tb30">
                        <div className="row">
                          <div className="col-lg-12 text-white">
                            <h2>
                              We provide high quality and cost effective
                              services
                            </h2>
                            <h5 className="m-b30">
            ...
            <div
              ...
              style={{
                backgroundImage: 'url(' + './images/pattern/pic1.jpg' + ')',
              }}
            >
              <div className="container">
                ...
                <div className="row text-center">
                    ...
                    <div className="dlab-box">
                      ...
                      <div className="dlab-info p-a30 border-1 bg-white">
                        <h5 className="dlab-title m-t0">
                          <a href="/#">Understand the situation</a>
                        </h5>
                        <p className="m-b0">
                          Lorem ipsum dolor Fusce varius euismod lacus eget
                          feugiat rorem ipsum dolor consectetur...
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="dlab-box">
                      ...
                      <div className="dlab-info p-a30 border-1 bg-white">
                        <h5 className="dlab-title m-t0">
                          <a href="/#">Bring the experience to life</a>
                        </h5>
                        <p className="m-b0">
                          Lorem ipsum dolor Fusce varius euismod lacus eget
                          feugiat rorem ipsum dolor consectetur...
                  ...
                  >
                    <div className="dlab-box">
                      ...
                      <div className="dlab-info p-a30 border-1 bg-white">
                        <h5 className="dlab-title m-t0">
                          <a href="/#">Strategise chart the course</a>
                        </h5>
                        <p className="m-b0">
                          Lorem ipsum dolor Fusce varius euismod lacus eget
                          feugiat rorem ipsum dolor consectetur...
            ...
            >
              <div className="container">
                <div className="section-content">
                  <div className="row">
                    <div
                      className="col-6 col-lg-3 col-md-6 col-sm-6 col-12 m-b30 wow fadeIn"
                      data-wow-delay="0.2s"
                    >
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="text-center max-w600 m-auto ">
                      <div className="m-b20">
                        <i className="fa fa-quote-left font-45 text-primary"></i>
                      </div>
                      <h4 className="text-uppercase font-weight-700 font-30">
                      ...
                      >
                        <span className="p-lr10">Start New Projects</span>
                      </a>
                    </div>
                  </div>
                </div>
