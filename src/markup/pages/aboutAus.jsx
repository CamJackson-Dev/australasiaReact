...
class AboutAus extends Component {
  render() {
    return (
      <>
        <Header1 />
        <div className="page-content bg-white">
          <div
            ...
            style={{
              backgroundImage: 'url(' + './images/main-slider/uluru.jpg' + ')',
            }}
          >
            <div className="container">
              <div className="dlab-bnr-inr-entry">
                <h1 className="text-white">About New Australia</h1>
            ...
            >
              <div className="container">
                ...
                <div className=" row dzseth  m-b30">
                  <div
                    className="col-lg-6 col-md-12 m-b30 about-img wow fadeIn"
                    data-wow-delay="0.8s"
                  >
                ...
                <div className="row dzseth column-reverse">
                  ...
                  <div
                    className="col-lg-6 col-md-12 about-img wow fadeIn"
                    data-wow-delay="0.8s"
                  >
