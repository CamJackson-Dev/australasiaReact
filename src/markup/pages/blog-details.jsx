    ...
    return (
      <>
        ...
        <div class="page-content bg-white">
          <div
            class="dlab-bnr-inr dlab-bnr-inr-sm overlay-primary bg-pt"
            style={{
              ...
              <div class="row">
                <div class="col-lg-8 col-xl-9">
                  <div class="blog-post blog-single">
                    ...
                    <div class="dlab-post-meta m-b20">
                      <ul class="d-flex align-items-center">
                        ...
                        <li class="post-author">
                          <i class="fa fa-user"></i>By <a href="/#">demongo</a>{' '}
                        </li>
                    ...
                    <div
                      class="dlab-post-media dlab-img-effect zoom-slow wow fadeIn"
                      data-wow-delay="0.2s"
                    >
                      {' '}
                      <a href="/#">
                    ...
                    <div class="dlab-post-text">
                      <p>
                        ...
                        text of the printing and typesetting printer a galley
                        Lorem Ipsum is simply dummy text of the printing and
                        ...
                        popularised in 1960s with the release of Letraset sheets
                    ...
                    <div class="dlab-post-tags clear">
                      <div class="post-tags">
                        {' '}
                        <a href="/#">Child </a> <a href="/#">Eduction </a>{' '}
                        <a href="/#">Money </a> <a href="/#">Resturent </a>{' '}
                      </div>
                    </div>
                    <div class="dlab-divider bg-gray-dark op4">
                    ...
                    <div class="share-details-btn">
                      <ul>
                        ...
                        <li>
                          <a href="/#" class="site-button facebook button-sm">
                        ...
                        <li>
                          <a
                            href="/#"
                            class="site-button google-plus button-sm"
                          >
                            <i class="fa fa-google-plus"></i> Google Plus
                          </a>
                        </li>
                        <li>
                          <a href="/#" class="site-button linkedin button-sm">
                            <i class="fa fa-linkedin"></i> Linkedin
                          </a>
                        </li>
                        <li>
                          <a href="/#" class="site-button instagram button-sm">
                            <i class="fa fa-instagram"></i> Instagram
                          </a>
                        </li>
                        <li>
                          <a href="/#" class="site-button twitter button-sm">
                            <i class="fa fa-twitter"></i> Twitter
                          </a>
                        </li>
                        <li>
                          <a href="/#" class="site-button whatsapp button-sm">
                        ...
                        >
                          ...
                          <div class="input-group">
                            ...
                            <button
                              ...
                              value="Submit"
                              type="submit"
                              class="site-button btn-block radius-no"
                            >
                              Subscribe Now
                            </button>
                          </div>
                      ...
                      <ul>
                        <li>
                          <div class="dlab-post-thum">
                            <a
                              href="/#"
                              class="dlab-img-overlay1 dlab-img-effect zoom-slow"
                            >
