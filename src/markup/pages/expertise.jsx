                ...
                <div className="row">
                  <div className="col-lg-8 col-md-7">
                    ...
                    <div className="row serv">
                      <div
                        className="col-lg-6 col-md-12 col-sm-6 m-b30 wow fadeInUp"
                        data-wow-delay="0.2s"
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            ...
                            <a href="/#" className="icon-cell">
                              <img src="images/expertise/php.png" alt="" />
                            </a>{' '}
                          </div>
                      ...
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            {' '}
                            <a href="/#" className="icon-cell">
                              <img src="images/expertise/joomla.png" alt="" />
                            </a>{' '}
                          </div>
                          <div className="icon-content">
                            <h5 className="dlab-tilte text-uppercase">
                      ...
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            {' '}
                            <a href="/#" className="icon-cell">
                              <img src="images/expertise/drupal.png" alt="" />
                            </a>{' '}
                          </div>
                          <div className="icon-content">
                            <h5 className="dlab-tilte text-uppercase">
                      ...
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            {' '}
                            <a href="/#" className="icon-cell">
                              <img src="images/expertise/laravel.png" alt="" />
                            </a>{' '}
                          </div>
                          <div className="icon-content">
                            <h5 className="dlab-tilte text-uppercase">
                      ...
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            {' '}
                            <a href="/#" className="icon-cell">
                              <img src="images/expertise/magento.png" alt="" />
                            </a>{' '}
                          </div>
                          <div className="icon-content">
                            <h5 className="dlab-tilte text-uppercase">
                              <a href="/#">Magento 1.x</a>
                            </h5>
                            <p>
                              Lorem ipsum dolor sit amet, consectetuer
                              adipiscing elit, sed diam nonummy nibh euismod..
                      ...
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            ...
                            <a href="/#" className="icon-cell">
                              <img
                                src="images/expertise/oscommerce.png"
                                alt=""
                              />
                            </a>{' '}
                          </div>
                      ...
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            ...
                            <a href="/#" className="icon-cell">
                              <img
                                src="images/expertise/ecommerce.png"
                                alt=""
                              />
                            </a>{' '}
                          </div>
                      ...
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            ...
                            <a href="/#" className="icon-cell">
                              <img
                                src="images/expertise/zend-framework.png"
                                alt=""
                              />
                            </a>{' '}
                          </div>
                      ...
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            ...
                            <a href="/#" className="icon-cell">
                              <img
                                src="images/expertise/ruby-rails.png"
                                alt=""
                              />
                            </a>{' '}
                          </div>
                      ...
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            {' '}
                            <a href="/#" className="icon-cell">
                              <img src="images/expertise/zencart.png" alt="" />
                            </a>{' '}
                          </div>
                          <div className="icon-content">
                            <h5 className="dlab-tilte text-uppercase">
                      ...
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            {' '}
                            <a href="/#" className="icon-cell">
                              <img src="images/expertise/xcart.png" alt="" />
                            </a>{' '}
                          </div>
                          <div className="icon-content">
                            <h5 className="dlab-tilte text-uppercase">
                      ...
                      >
                        <div className="icon-bx-wraper expertise  bx-style-1 p-a30 center">
                          <div className="icon-lg m-b20">
                            ...
                            <a href="/#" className="icon-cell">
                              <img
                                src="images/expertise/python-framework.png"
                                alt=""
                              />
                            </a>{' '}
                          </div>
                  ...
                  <div className="col-lg-4 col-md-5 sticky-top">
                    <form
                      className="inquiry-form inner wow fadeInUp dzForm"
                      data-wow-delay="0.2s"
