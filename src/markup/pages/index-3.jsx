        ...
        <div className="page-content bg-white">
          ...
          <div className="content-block">
            ...
            <div
              ...
              style={{
                backgroundImage: 'url(' + './images/background/bg15.jpg' + ')',
            ...
            >
              <div className="container">
                <div className="row">
                  ...
                  >
                    <div
                      className="dlab-box-bg m-b30 box-hover active fly-box"
                      style={{
                        backgroundImage:
                          'url(' + './images/our-work/pic3.jpg' + ')',
                      }}
                    >
                      <div className="icon-bx-wraper center p-lr20 p-tb30">
                        <div className="text-primary">
              ...
              <div className="container">
                <div className="row">
                  <div className="col-md-12 col-lg-12 text-center section-head">
                    <h2 className="font-weight-700 max-w700 m-auto">
                      Invest in Our Company and have Healthy Profits for Long
                      Term
                    </h2>
                    <p className="m-b0">
                ...
                <div className="row">
                  <div
                    className="col-md-6 col-lg-4 col-sm-6 m-b30 wow fadeIn"
                    data-wow-delay="0.2s"
                  >
                    <div className="dlab-box">
                      ...
                      <div className="dlab-info p-a30 border-1 bg-white">
                        ...
                        <p className="m-b15">
                          ...
                          feugiat rorem ipsum dolor consectetur Fusce varius
                          [...]{' '}
                        </p>
                      </div>
                    </div>
                  ...
                  <div
                    className="col-md-12 col-lg-4 col-sm-6 m-b30 wow fadeIn"
                    data-wow-delay="0.6s"
                  >
                    <div className="dlab-box">
                      <div className="dlab-media dlab-img-overlay5">
            ...
            <div
              className="section-full content-inner bg-img-fix bg-img-fix"
              style={{
                backgroundImage: 'url(' + './images/background/bg12.jpg' + ')',
              }}
            >
              <div className="container">
                <div className="row m-b30">
                  <div
                    className="col-lg-4 col-md-12 align-self-center wow fadeInLeft"
                    data-wow-delay="0.2s"
                  >
                    <h5>Who We Are</h5>
                  ...
                  <div className="col-lg-8 col-md-12">
                    <div className="row">
                      <div
                        className="col-lg-4 col-md-4 col-sm-6 wow fadeIn"
                        data-wow-delay="0.2s"
                      >
                        <div className="icon-bx-wraper bx-style-1 p-tb30 p-lr20 m-b30 center br-col-b1 bg-white">
                          ...
                          <div className="icon-content">
                            ...
                            <p className="m-b0 font-14">
                              Take a trivial example, which seds ever undertakes
                              laborious.
                            </p>
                          </div>
                        </div>
                      ...
                      <div
                        className="col-lg-4 col-md-4 col-sm-12 wow fadeIn"
                        data-wow-delay="0.6s"
                      >
                        <div className="icon-bx-wraper bx-style-1 p-tb30 p-lr20 m-b30 center br-col-b1 bg-white">
                ...
                <div className="row">
                  <div
                    className="col-lg-6 col-md-6 col-sm-6 m-b30 wow fadeIn"
                    data-wow-delay="0.2s"
                  >
                    <img
                      src="images/about/aboutNz.jpg"
                      className="radius-sm"
                      alt=""
                    />
                  </div>
            ...
            <div
              className="section-full content-inner-2 bg-primary bg-img-fix overlay-primary tax-info-chart"
              style={{
            ...
            >
              <div className="container">
                <div className="row dzseth">
                  <div
                    className="col-lg-6 col-md-12 col-sm-12 d-flex mb-4 mb-md-4 mb-lg-0 wow fadeInLeft"
                    data-wow-delay="0.2s"
                  >
                  ...
                  <div className="col-lg-6 col-md-12 col-sm-12 dis-tbl d-flex">
                    <div
                      className="bg-white text-black p-a30 p-t40 form-tax align-self-center wow fadeInRight"
                      data-wow-delay="0.4s"
                    >
                      <div className="row">
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-6 m-b30">
                    <div className="team-section">
                      ...
                      <div className="team-content text-white">
                        ...
                        <h6 className="text-uppercase text-black m-b0">
                          John Deo
                        </h6>
              ...
              <div className="container">
                <div className="row ">
                  <div className="col-lg-12 text-center section-head">
                    ...
                    <h5 className="m-b0 font-weight-300 max-w600 m-auto">
                      Our unmatched quality services are recognized by world's
                      top research &amp; review companies
                    </h5>
                  </div>
                </div>
                <div className="row m-b30">
                  <div className="col-md-2 col-sm-4 col-6 m-b30">
                    <div className="br-col-b1 border-1">
                      <img src="images/client-logo/logo/logo1.jpg" alt="" />
                    </div>
                  </div>
                  <div className="col-md-2 col-sm-4 col-6 m-b30">
                    <div className="br-col-b1 border-1">
                      <img src="images/client-logo/logo/logo2.jpg" alt="" />
                    </div>
                  </div>
                  <div className="col-md-2 col-sm-4 col-6 m-b30">
                    <div className="br-col-b1 border-1">
                      <img src="images/client-logo/logo/logo3.jpg" alt="" />
                    </div>
                  </div>
                  <div className="col-md-2 col-sm-4 col-6 m-b30">
                    <div className="br-col-b1 border-1">
                      <img src="images/client-logo/logo/logo4.jpg" alt="" />
                    </div>
                  </div>
                  <div className="col-md-2 col-sm-4 col-6 m-b30">
                    <div className="br-col-b1 border-1">
                  ...
                  <div className="col-md-2 col-sm-4 col-6 m-b30">
                    <div className="br-col-b1 border-1">
                      <img src="images/client-logo/logo/logo5.jpg" alt="" />
                    </div>
                  </div>
                  <div className="col-md-2 col-sm-4 col-6 m-b30">
                    <div className="br-col-b1 border-1">
                ...
                <div className="row">
                  <div className="col-md-12 text-center">
                    <Link to={'#'} className="site-button button-md">
                      View All Partner
                    </Link>
                  </div>
                </div>
            ...
            <div
              className="section-full content-inner bg-img-fix"
              style={{
                backgroundImage: 'url(' + './images/background/bg14.jpg' + ')',
              }}
            >
              <div className="container">
                <div className="row">
