          ...
          <div className="content-block">
            ...
            >
              <div className="container">
                <div className="row align-items-center d-flex">
                  <div className="col-lg-8 col-md-7">
                    <div className="row">
                      <div className="col-5 bubbx1">
                        <div
                          className="bubbles-bx bubbles-bx1 wow zoomIn"
                          data-wow-delay="0.2s"
                          style={{
                            backgroundImage:
                              'url(' + './images/bubbles/bubbles1.png' + ')',
                          }}
                        >
                          <div className="bubinbox">
                            <div className="text-primary">
                              <span className="icon-cell icon-lg">
                                <img src="images/bubbles/icon1.png" alt="" />
                              </span>
                            </div>
                        ...
                        <div
                          className="bubbles-bx bubbles-bx2 ml-auto wow zoomIn"
                          data-wow-delay="0.4s"
                          style={{
                            backgroundImage:
                              'url(' + './images/bubbles/bubbles3.png' + ')',
                          }}
                        >
                          <div className="bubinbox">
                            <div className="text-primary">
                              <span className="icon-cell icon-lg">
                                <img src="images/bubbles/icon3.png" alt="" />
                              </span>
                            </div>
                            <h5 className="dlab-tilte">Diamond</h5>
                          </div>
                      ...
                      <div className="col-3 bubbx1">
                        <div
                          className="bubbles-bx bubbles-bx3 wow zoomIn"
                          data-wow-delay="0.6s"
                          style={{
                            backgroundImage:
                              'url(' + './images/bubbles/bubbles2.png' + ')',
                          }}
                        >
                          <div className="bubinbox">
                            <div className="text-primary">
                              <span className="icon-cell icon-lg">
                                <img src="images/bubbles/icon2.png" alt="" />
                              </span>
                            </div>
                        ...
                        <div
                          className="bubbles-bx bubbles-bx4 wow zoomIn"
                          data-wow-delay="0.8s"
                          style={{
                            backgroundImage:
                              'url(' + './images/bubbles/bubbles4.png' + ')',
                          }}
                        >
                          <div className="bubinbox">
                            <div className="text-primary">
                              <span className="icon-cell icon-lg">
                                <img src="images/bubbles/icon4.png" alt="" />
                              </span>
                            </div>
                      ...
                      <div className="col-4 bubbx1 d-flex align-items-center">
                        <div
                          className="bubbles-bx bubbles-bx5 wow zoomIn"
                          data-wow-delay="1s"
                          style={{
                            backgroundImage:
                              'url(' + './images/bubbles/bubbles5.png' + ')',
                          }}
                        >
                          <div className="bubinbox">
                            <div className="text-primary">
                              <span className="icon-cell icon-lg">
                                <img src="images/bubbles/icon5.png" alt="" />
                              </span>
                            </div>
                  ...
                  <div
                    className="col-lg-4 col-md-5 title-bx about-bx2-content text-right wow fadeInRight"
                    data-wow-delay="1.2s"
                  >
                    ...
                    <p>
                      ...
                      risus, a euismod lorem tincidunt id. Vestibulum imperdiet
                      nibh vel magna lacinia ultrices. Nam ac elit a ante
                      commodo tristique
                    </p>
                    <a
              ...
              <div className="setResizeMargin">
                ...
                <div className="content-section">
                  ...
                  <div className="m-t30">
                    <a
                      href="javascript:void(0);"
                      className="site-button button-md btn-long radius-xl"
                    >
                      Read More
                    </a>
                  </div>
                ...
                <div className="container">
                  ...
                  <div className="row align-items-center d-flex">
                    <div className="col-md-12 col-lg-3">
                      <div
                        className="product-box wow zoomIn"
                        data-wow-delay="1s"
                      >
                        ...
                        <div className="product-details">
                          <h4 className="product-title">
                            <a href="shop-product-details">Product Name here</a>
                          </h4>
                      ...
                      <div className="row align-items-end d-flex">
                        <div className="col-lg-8 col-md-6 col-sm-12">
                          ...
                          >
                            ...
                            <div className="product-img">
                              <img
                                src="images/product/watch/item2.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                          <div
                            className="product-box product-sm wow zoomIn"
                            data-wow-delay="0.8s"
                          >
                            <div className="product-img">
                              <img
                                src="images/product/watch/item3.jpg"
                                alt=""
                              />
                            </div>
                            <div className="product-details">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6 d-flex align-self-start">
                          ...
                          >
                            <div className="product-img">
                              <img
                                src="images/product/watch/item5.jpg"
                                alt=""
                              />
                            </div>
                            <div className="product-details">
                        ...
                        <div className="col-lg-8 col-md-6 col-sm-12">
                          ...
                          >
                            ...
                            <div className="product-img">
                              <img
                                src="images/product/watch/item6.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                ...
                <div className="setResizeMargin">
                  <div className="row m-a0 d-flex align-items-center">
                    ...
                    <div className="col-lg-8 col-md-6 text-right">
                      <div
                        className="feature-img-bx wow zoomIn"
                        data-wow-delay="1s"
                        data-wow-duration="3s"
                      >
                        <img
                          src="images/background/bg8.png"
                          alt=""
                          className=""
                        />
                      </div>
            ...
            <div className="content-inner pro-client-review">
              <div className="container">
                <div className="section-head title-bx text-center">
                  <h2>
                    What our Customer Reviews <br /> About Us
                  </h2>
                </div>
                <div className="row">
                  <div className="col-lg-4 col-md-4 col-sm-12">
                    <div
                      className="flip-bx testimonial-flip wow fadeInUp"
                      data-wow-delay="0.2s"
              ...
              <div className="container">
                ...
                <div className="row">
                  <div className="col-md-4">
                    <div
                      className="blog-post blog-bx blog-img-bottom wow fadeInUp"
                      data-wow-delay="0.2s"
                      data-wow-duration="1s"
                    >
                      <div className="dlab-post-info">
                        ...
                        <div className="dlab-post-title ">
                          <h3 className="post-title">
                            <a href="javascript:void(0);">
                              How to find, install, apps on your Apple Watch
                            </a>
                          </h3>
                        </div>
                        ...
                        <div className="dlab-post-text">
                          <p>
                            Third-party Apple Watch apps aren't truly apps —
                            they're iPhone app extensions. As such, when you
                            download an iPhone app with an Apple
                          </p>
                        </div>
                  ...
                  <div className="col-md-4">
                    <div
                      className="blog-post blog-bx wow fadeInUp"
                      data-wow-delay="0.4s"
                      data-wow-duration="1s"
                    >
                      <div className="dlab-post-media blog-curve-img">
                  ...
                  <div className="col-md-4">
                    ...
                    >
                      ...
                      <div className="dlab-post-media blog-curve-img">
                        <a href="javascript:void(0);">
                          <img src="images/blog/latest-blog/pic3.png" alt="" />
                        </a>
                      </div>
                    </div>
                  </div>
            ...
            <div className="content-inner newsletter-bx">
              <div className="container">
                <form
                  className="row text-white dezPlaceAni align-items-center dzSubscribe m-lr0 wow fadeInUp"
                  data-wow-delay="0.4s"
                  data-wow-duration="1s"
                ...
                >
                  <div className="col-xl-5 col-lg-6 col-md-12">
                    <div className="title-bx">
                      <h2 className="m-b0">
                        Join our monthly <br /> newsletter
                      </h2>
                    </div>
                  </div>
            ...
            {/* <!-- Our Team --> */}
            <div
              className="content-inner newsletter-bx"
              style={{
              ...
              <div className="container">
                ...
                <div className="row">
                  <div className="col-lg-4 col-md-6">
                    <div
                      className="dlab-box team-curve-bx wow fadeInUp"
                      data-wow-delay="0.2s"
                      data-wow-duration="1s"
                    >
            ...
            <div className="container m-t80 ">
              ...
              <div className="app-btn-bx text-center">
                <a
                  href="javascript:void(0);"
                  className="site-button radius-xl m-lr5 wow fadeInUp"
                  data-wow-delay="0.5s"
                  data-wow-duration="1s"
                >
