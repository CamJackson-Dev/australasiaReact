      ...
      <>
        ...
        <div className="page-content bg-white">
          ...
          <div className="content-block">
              ...
              <div className="container">
                <div className="row ">
                  <div className="col-lg-7 col-md-8">
                    <div
                      className="abuot-box row wow fadeIn"
                      data-wow-delay="0.6s"
                    >
              ...
              <div className="choses-info text-white">
                <div className="container-fluid">
                  <div className="row choses-info-content">
                    <div
                      className="col-6 col-lg-3 col-md-3 col-sm-6 p-a30 wow zoomIn"
                      data-wow-delay="0.2s"
                    >
            ...
            {/* <!-- Our Portfolio --> */}
            <div
              className="section-full content-inner-1 mfp-gallery wow fadeIn"
              data-wow-delay="0.4s"
            >
              <div className="container-fluid">
