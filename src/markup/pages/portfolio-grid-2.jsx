        ...
        return (
            <>
                ...
                <div className="page-content bg-white">
                    {/* <!-- inner page banner --> */}
                    <div className="dlab-bnr-inr dlab-bnr-inr-sm overlay-primary bg-pt" style={{ backgroundImage: "url(" + './images/banner/bnr10.jpg' + ")" }}>
                            ...
                            <div className="container">
                                ...
                                <div className="clearfix">
                                    <ul id="masonry" className="dlab-gallery-listing gallery-grid-4 gallery mfp-gallery port-style1">
                                        <li className="web design card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.2s">
                                                    ...
                                                    <div className="overlay-bx ">
                                                        <div className="overlay-icon align-b text-white text-left">
                                                            <div className="text-white text-left port-box">
                                                                <h4 className="m-a0">Herbal Beauty Salon</h4>
                                        ...
                                        <li className="advertising branding photography card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.4s">
                                            <div className="dlab-box dlab-gallery-box">
                                        ...
                                        <li className="branding design photography card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.6s">
                                            <div className="dlab-box dlab-gallery-box">
                                                <div className="dlab-media dlab-img-overlay1 dlab-img-effect">
                                        ...
                                        <li className="web design card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.8s">
                                            <div className="dlab-box dlab-gallery-box">
                                                <div className="dlab-media dlab-img-overlay1 dlab-img-effect">
                                        ...
                                        <li className="web branding card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.2s">
                                            <div className="dlab-box dlab-gallery-box">
                                                <div className="dlab-media dlab-img-overlay1 dlab-img-effect">
                                        ...
                                        <li className="advertising design photography card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.4s">
                                            <div className="dlab-box dlab-gallery-box">
                                                <div className="dlab-media dlab-img-overlay1 dlab-img-effect ">
                                        ...
                                        <li className="web branding card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.6s">
                                            <div className="dlab-box dlab-gallery-box">
                                                <div className="dlab-media dlab-img-overlay1 dlab-img-effect">
                                        ...
                                        <li className="advertising design photography card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.8s">
                                            <div className="dlab-box dlab-gallery-box">
                                                <div className="dlab-media dlab-img-overlay1 dlab-img-effect dlab-img-effect ">
                                        ...
                                        <li className="web photography card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.2s">
                                            <div className="dlab-box dlab-gallery-box">
                                                <div className="dlab-media dlab-img-overlay1 dlab-img-effect">
                                        ...
                                        <li className="advertising branding card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.4s">
                                            <div className="dlab-box dlab-gallery-box">
                                                <div className="dlab-media dlab-img-overlay1 dlab-img-effect">
                                        ...
                                        <li className="web design card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.6s">
                                            <div className="dlab-box dlab-gallery-box">
                                                <div className="dlab-media dlab-img-overlay1 dlab-img-effect">
                                        ...
                                        <li className="advertising branding photography card-container col-lg-6 col-md-6 col-sm-6 p-a0 wow zoomIn" data-wow-delay="0.8s">
                                            <div className="dlab-box dlab-gallery-box">
                                                <div className="dlab-media dlab-img-overlay1 dlab-img-effect ">
