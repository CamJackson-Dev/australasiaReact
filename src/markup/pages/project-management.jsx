              ...
              <div className="container">
                <div className="section-head text-black text-center">
                  ...
                  <h2 className="box-title m-tb0">
                    Information Flow in the Right Direction + Keeping all
                    concerned in the loop = Effective Project Management
                    ...
                    <div className="time-line clearfix">
                      <div className="line-left clearfix">
                        <div className="line-left-box">
                          <div
                            className="line-content-box wow fadeInLeft"
                          ...
                          >
                            ...
                            <p className="font-16">
                              ...
                              nature of the clients. we can talk.
                            </p>
                          </div>
                      ...
                      <div className="line-right clearfix">
                        <div className="line-right-box">
                          <div
                            className="line-content-box wow fadeInRight"
                            data-wow-duration="1.80s"
