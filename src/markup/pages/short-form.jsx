      ...
      <>
        ...
        <div class="page-content bg-white">
          ...
          <div class="content-block">
            {/* <!-- Contact Us --> */}
            <div
              class="section-full content-inner-2 bg-white contact-form-bx"
              style={{
                backgroundImage: 'url(' + './images/background/bg16.jpg' + ')',
              }}
            >
              <div class="sort-title-bx" data-name="Element Style 1">
                Element Style 1 <i class="fa fa-angle-double-right"></i>
              </div>
              <div class="container">
                <div class="section-head text-center">
                  <h2 class="text-uppercase">
                    <span class="font-weight-300">Contact </span> us
                  </h2>
                </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                        <button
                          ...
                          type="submit"
                          value="Submit"
                          class="site-button outline outline-2 radius-xl button-md m-t30"
                        >
                          Submit Now
                        </button>
                      </div>
            ...
            {/* <!-- Contact Us End --> */}
            <div
              class="section-full content-inner-2 bg-primary bg-img-fix overlay-primary tax-info-chart"
              style={{
                backgroundImage: 'url(' + './images/background/bg3.jpg' + ')',
              }}
            >
              <div class="sort-title-bx text-white" data-name="Element Style 2">
                Element Style 2 <i class="fa fa-angle-double-right"></i>
              </div>
              <div class="container">
                <div class="row dzseth">
                  <div
                    class="col-lg-6 col-md-12 col-sm-12 d-flex mb-4 mb-md-4 mb-lg-0 wow fadeInLeft"
                    data-wow-delay="0.2s"
                  >
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12 dis-tbl d-flex">
                    <div
                      class="bg-white text-black p-a30 p-t40 form-tax align-self-center wow fadeInRight"
                      data-wow-delay="0.4s"
                    >
                      <div class="row">
                      ...
                      <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-3 col-sm-12 col-12 mb-4 d-flex">
                          <div class="calculate align-self-end btn-block">
                            <button class="site-button btn-block" type="button">
                              Calculate
                            </button>
                          </div>
                        </div>
            ...
            <div class="section-full content-inner-2 shop-account">
              <div class="sort-title-bx" data-name="Element Style 3">
                Element Style 3 <i class="fa fa-angle-double-right"></i>
              </div>
              {/* <!-- Product --> */}
              <div class="container">
                <div class="row">
                      ...
                      <div class="tab-content nav">
                        ...
                        >
                          ...
                          <div class="text-left">
                            ...
                            <button class="site-button pull-right button-lg radius-no">
                              Submit
                            </button>
                          </div>
                        </form>
            ...
            >
              <div class="sort-title-bx text-white" data-name="Element Style 4">
                Element Style 4 <i class="fa fa-angle-double-right"></i>
              </div>
              <div class="container">
                <div class="row">
