      ...
      <>
        ...
        <div className="page-content bg-white">
          ...
          <div className="content-block">
            ...
            {/* <!-- Our Services --> */}
            <div
              className="section-full content-inner-2 overlay-primary bg-img-fix"
              style={{
            ...
            <div className="section-full content-inner bg-white">
              <div className="sort-title-bx" data-name="Element Style 3">
                Element Style 3 <i className="fa fa-angle-double-right"></i>
              </div>
              <div className="container">
            ...
            <div className="section-full bg-black-light content-inner">
              <div
                className="sort-title-bx text-white"
                data-name="Element Style 4"
              >
                Element Style 4 <i className="fa fa-angle-double-right"></i>
              </div>
              <div className="container">
                <div className="row">
                  <div
            ...
            <div className="section-full content-inner">
              <div className="sort-title-bx" data-name="Element Style 5">
                Element Style 5 <i className="fa fa-angle-double-right"></i>
              </div>
              <div className="container">
                <div className="row ">
                  <div
                ...
                <div className="row serv">
                  <div
                    className="col-lg-2 col-md-4 col-sm-6 m-b30 wow fadeInUp"
                    data-wow-delay="0.2s"
                  >
            ...
            >
              <div className="sort-title-bx" data-name="Element Style 6">
                Element Style 6 <i className="fa fa-angle-double-right"></i>
              </div>
              <div className="container">
                <div className="row">
                  <div
            ...
            <div className="section-full facility bg-gray">
              <div
                className="sort-title-bx text-white"
                data-name="Element Style 7"
              >
                Element Style 7 <i className="fa fa-angle-double-right"></i>
              </div>
            ...
            >
              <div className="sort-title-bx" data-name="Element Style 8">
                Element Style 8 <i className="fa fa-angle-double-right"></i>
              </div>
              <div className="container">
            ...
            {/* <!-- Why Chose Us --> */}
            <div
              className="section-full content-inner overlay-primary about-service bg-img-fix"
              style={{
                backgroundImage: 'url(' + './images/background/bg1.jpg' + ')',
              }}
            >
              <div
                className="sort-title-bx text-white"
                data-name="Element Style 9"
              >
                Element Style 9 <i className="fa fa-angle-double-right"></i>
              </div>
              <div className="container">
            ...
            <div className="section-full content-inner">
              <div className="sort-title-bx" data-name="Element Style 10">
                Element Style 10 <i className="fa fa-angle-double-right"></i>
              </div>
              <div className="container">
                <div className="row">
                  <div
                    className="col-lg-4 col-md-12 col-sm-12 m-b30 wow fadeInUp"
                    data-wow-delay="0.2s"
                  >
