          ...
          <div className="content-block">
                      ...
                      <ul className="nav nav-tabs ">
                        ...
                        <li>
                          <a data-toggle="tab" href="#graphic-design-1">
                            <i className="fa fa-photo"></i> Additional
                            Information
                          </a>
                        </li>
                        <li>
                      ...
                      <div className="tab-content">
                        <div id="web-design-1" className="tab-pane active">
                          <p className="m-b10">
                            ...
                            pulvinar lectus a est Curabitur eget orci Cras
                                ...
                                <div className="comment_container">
                                  ...
                                  <div className="comment-text">
                                    ...
                                    <p className="meta">
                                      ...
                                      <span>
                                        <i className="fa fa-clock-o"></i> March
                                        7, 2013
                                      </span>{' '}
                                    </p>
            ...
            >
              ...
              <div className="container-fluid">
                <div
                  className="dlab-tabs choseus-tabs wow fadeIn"
                  data-wow-delay="0.4s"
                >
                  <ul className="nav row justify-content-center">
                    <li>
                      <a data-toggle="tab" href="#cost" className="active">
                    ...
                    <li>
                      <a data-toggle="tab" href="#packages">
                ...
                <div className="tab-content chosesus-content">
                  <div id="cost" className="tab-pane active">
                    <div className="row p-t50">
                      <div
                        className="col-lg-6 m-b10 col-md-4 about-img wow fadeIn"
                        data-wow-delay="0.4s"
                      >
                      ...
                      <div className="col-lg-6 col-md-8 text-white">
                        <div
                          className="p-l30 wow fadeInRight"
                          data-wow-delay="0.6s"
                        >
                        ...
                        <div
                          className="abuot-box p-lr30 wow fadeInLeft"
                          data-wow-delay="0.6s"
                        >
                          <p>
