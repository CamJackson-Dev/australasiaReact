        ...
        <div className="page-content bg-white">
          ...
          <div className="content-block">
            ...
            <div className="section-full text-center bg-gray content-inner">
              <div
                className="sort-title-bx text-left"
              ...
              <div className="container">
                ...
                <div className="row">
                  <div
                    className="col-lg-3 col-md-6 col-sm-6 m-b5 wow fadeInUp"
                    data-wow-delay="0.2s"
                  >
                    <div className="dlab-box">
                      <div className="dlab-media dlab-img-overlay6 dlab-img-effect radius-sm">
                        {' '}
                        <img src="images/our-team/pic5.jpg" alt="" />
                  ...
                  >
                    <div className="dlab-box">
                      <div className="dlab-media dlab-img-overlay6 dlab-img-effect radius-sm">
                        {' '}
                        <img src="images/our-team/pic6.jpg" alt="" />
                        <div className="overlay-bx">
                          <div className="overlay-icon">
                            <ul className="dlab-social-icon">
                              <li>
                  ...
                  >
                    <div className="dlab-box">
                      <div className="dlab-media dlab-img-overlay6 dlab-img-effect radius-sm">
                        {' '}
                        <img src="images/our-team/pic7.jpg" alt="" />
                        <div className="overlay-bx">
                          <div className="overlay-icon">
                            <ul className="dlab-social-icon">
                              <li>
                  ...
                  <div
                    className="col-lg-3 col-md-6 col-sm-6 col-sm-6 m-b5 wow fadeInUp"
                    data-wow-delay="0.8s"
                  >
                    <div className="dlab-box">
                      <div className="dlab-media dlab-img-overlay6 dlab-img-effect radius-sm">
                        {' '}
                        <img src="images/our-team/pic8.jpg" alt="" />
                        <div className="overlay-bx">
                          <div className="overlay-icon">
                            <ul className="dlab-social-icon">
                              <li>
