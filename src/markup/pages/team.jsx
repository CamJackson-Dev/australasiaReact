      ...
      <>
        ...
        <div class="page-content bg-white">
          ...
          <div
            ...
            style={{
              backgroundImage: 'url(' + './images/banner/bnr3.jpg' + ')',
            }}
          >
            <div class="container">
          ...
          <div class="content-block">
            ...
            <div class="section-full text-center bg-white content-inner-1">
              <div class="container">
                ...
                <div class="row">
                  <div
                    class="col-lg-3 col-md-6 col-sm-6 m-b5 wow fadeInUp"
                    data-wow-delay="0.2s"
                  >
                    <div class="dlab-box">
                            ...
                            <ul class="dlab-social-icon">
                              <li>
                                <a
                                  ...
                                  class="fa text-white fa-facebook"
                                ></a>
                              </li>
                              <li>
                                <a
                                  href="javascript:void(0);"
                                  class="fa text-white fa-twitter"
                                ></a>
                              </li>
                              <li>
                                <a
                                  href="javascript:void(0);"
                                  class="fa text-white fa-linkedin"
                                ></a>
                              </li>
                              <li>
                                <a
                  ...
                  <div
                    class="col-lg-3 col-md-6 col-sm-6 col-sm-6 m-b5 wow fadeInUp"
                    data-wow-delay="0.8s"
                  >
                    <div class="dlab-box">
                      <div class="dlab-media dlab-img-overlay6 dlab-img-effect radius-sm">
            ...
            {/* <!-- Mission And Vision --> */}
            <div
              class="section-ful our-about-info content-inner-1 wow fadeIn "
              data-wow-delay="0.4s"
              style={{
                backgroundImage:
                  'url(' + './images/background/bg-map.jpg' + ')',
              }}
            >
              <div class="container">
                <div class="section-head text-center">
                  <h2 class="box-title m-tb0">
                    Mission And Vision<span class="bg-primary"></span>
                  </h2>
                  <p>
                    {' '}
                    Lorem Ipsum is simply dummy text of the printing and
                ...
                <div class="row dzseth m-b30">
                  <div
                    class="col-lg-6 col-md-6 m-b30 about-img wow fadeIn"
                    data-wow-delay="0.8s"
                  >
                  ...
                  <div class="col-lg-6 col-md-6 m-b30 dis-tbl text-justify">
                    <div class="dis-tbl-cell">
                      <h3 class="box-title">
                        Mision<span class="bg-primary"></span>
                      </h3>
                      <p class="font-16">
                        Lorem Ipsum is simply dummy text of the printing and
                ...
                <div class="row dzseth column-reverse">
                  <div class="col-lg-6 col-md-6 dis-tbl text-justify">
                    <div class="dis-tbl-cell">
                      <h3 class="box-title">
                        Vision<span class="bg-primary"></span>
                      </h3>
                      <p class="font-16">
                        Lorem Ipsum is simply dummy text of the printing and
                        typesetting industry. Lorem Ipsum has been the
                  ...
                  <div
                    class="col-lg-6 col-md-6 about-img wow fadeIn"
                    data-wow-delay="0.8s"
                  >
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="text-center max-w600 m-auto ">
                      <div class="m-b20">
                        <i class="fa fa-quote-left font-45 text-primary"></i>
                      </div>
                      <h4 class="text-uppercase font-weight-700 font-30">
                      ...
                      >
                        <span class="p-lr10">Start New Projects</span>
                      </a>
                    </div>
                  </div>
                </div>
